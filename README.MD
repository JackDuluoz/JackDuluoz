...
- :computer: Currently working on an events app with my classmates [James](https://github.com/jamesraymondbrown) and [Zak](https://github.com/Funk3). Stacks: MongoDB, Express, Angular w/ TypeScript.

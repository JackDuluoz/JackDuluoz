...
- :computer: Currently working on a MEAN app (MongoDB, Express, Angular w/ TypeScript) called 'yum'. It's GoodReads for restaurants!. See the [repo](https://github.com/JackDuluoz/yum) here.

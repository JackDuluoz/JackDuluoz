...
I'm Michael Green, a Full Stack Web Developer living in British Columbia, Canada. I made the switch to tech in 2022 and graduated with a diploma in Full Stack Web Dev in 2023. I worked in store management in the retail grocery industry for a decade before leaving to complete my MBA. During this time I discovered my passion for tech and decided it was time for a change.
...
- :computer: Currently working on 'yum', a MEAN app (MongoDB, Express, Angular w/ TypeScript) that aims to be the GoodReads for restaurants and eateries! Follow my progress by checking out the [repo](https://github.com/JackDuluoz/yum) here.
